    ...
    return (
        <form className="space-y-5 bg-white shadow p-10 rounded-lg" onSubmit={handleSubmit}>
            <div className="grid grid-cols-1 gap-3">
                ...
                <select className="border border-slate-300 p-2 rounded-lg w-full bg-white" name="category"
            ...
            <div className="grid grid-cols-1 gap-3">
                ...
                <input type="number" id="calories" className="border border-slate-300 p-2 rounded-lg"
                       placeholder="Calorias ej. 200, 300, etc" value={activity.calories} onChange={handleChange} />
            </div>
            <input type="submit" className="bg-gray-800 hover:bg-gray-900 p-2 w-full text-white cursor-pointer disabled:opacity-10 disabled:pointer-events-none"
                value={activity.category === 1 ? 'Guardar Comida' : 'Guadar Ejercicio'} disabled={!isValidActivity()} />
        </form>
    )
}

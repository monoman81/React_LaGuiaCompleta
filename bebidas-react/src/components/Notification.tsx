                        ...
                        <div className="p-4">
                            <div className="flex items-start">
                                ...
                                <div className="ml-4 flex flex-shrink-0">
                                    <button
                                        type="button"
                                        className="cursor-pointer inline-flex rounded-md bg-white text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
                                        onClick={close}
                                    >
